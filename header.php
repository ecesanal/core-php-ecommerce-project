    								...
    								<div class="regwrap">
    									<div class="row">
    										...
    										<div class="col-md-6">
    											...
    											<p>
    												Yeni kullanıcı mısın? Alışverişe şimdi başla,kaydını oluştur...
    											</p>
    											<form action="../eticaret/register" method="POST" role="form">
    												<a href="register"><button name="kullanicikaydet" class="btn btn-default btn-yellow">Kayıt Ol</button></a> </form>
    											</div>
    										</div>
    									</div>
    									<div class="srch-wrap">
