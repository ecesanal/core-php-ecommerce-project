	...
	<form action="nedmin/netting/islem.php" method="POST" class="form-horizontal checkout" role="form">
		<div class="row">
			<div class="col-md-6">
				...
				<div class="form-group dob">
					<div class="col-sm-12">
						...
						<input type="text" class="form-control"  required="" name="kullanici_adsoyad" value="<?php echo $kullanicicek['kullanici_adsoyad'] ?>" placeholder="Ad ve Soyadınızı Giriniz...">
					</div>
				</div>
				...
				<input type="hidden" name="kullanicibilgiguncelle" value="<?php echo $kullanicicek['kullanici_id'] ?>">
			...
			<div class="col-md-6">
				...
				<?php /* <center><img width="400" src="./dimg/sifremi-unuttum.jpg"></center>*/?>
			</div>
		</div>
	</div>
</form>
